  ...
  <section>
    <div class="section-content">
      ...
      <ul>
        ...
        <li>
          <p><strong>Country</strong> refers to: Nebraska, United States</p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
            this Agreement) refers to Tony Prokop.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Tony Prokop, accessible from
            <a
              href="tonyprokop.com"
      ...
      <ul>
        <li>By email: prokop.tony@gmail.com</li>
      </ul>
    </div>
  </section>
</template>
